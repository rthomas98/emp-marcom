        ...
        foreach ($caseStudies as $caseStudy) {
            ...
            if ($caseStudy->slug === 'mobile-banking-app') {
                $galleryImages = [
                    ...
                    [
                        'src' => '/images/site-images/rob_thomas23_A_Diverse_team_African_American_Happy__Mobile_de_addb40d4-04d4-481e-9072-f29d1dee05d1_3 (2).png',
                ...
                $galleryImages = [
                    ...
                    [
                        'src' => '/images/site-images/rob_thomas23_A_Diverse_team_African_American_white_men_and_wo_4d54bb42-096c-4b7b-ae8e-cee40c231aac_0.png',
                        'alt' => 'E-commerce development team'
                    ],
                    [
                        'src' => '/images/site-images/rob_thomas23_A_Diverse_team_African_American_white_men_and_wo_4d54bb42-096c-4b7b-ae8e-cee40c231aac_3.png',
                        'alt' => 'E-commerce platform design review'
                    ],
                    [
                        'src' => '/images/site-images/rob_thomas23_A_Diverse_team_African_American_white_men_and_wo_4d54bb42-096c-4b7b-ae8e-cee40c231aac_3 (1).png',
