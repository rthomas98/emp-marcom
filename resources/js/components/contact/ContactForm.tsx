        ...
        <section id="contact-form" className="px-[5%] py-16 md:py-24 lg:py-28">
            <div className="container mx-auto">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
                    <div>
                        <h2 className="mb-6 text-3xl font-bold text-[#1F1946] md:text-4xl lg:text-5xl">Contact Information</h2>
                        <p className="md:text-md mb-8 text-gray-700">
                            Fill out the form and a senior specialist will respond within one business day. You can also reach us directly using the
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm md:p-8">
                        <h2 className="mb-6 text-2xl font-bold text-[#1F1946] md:text-3xl">Send Us a Message</h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={formData.name}
                                        onChange={handleChange}
                                        className="w-full rounded-md border border-gray-300 px-4 py-2 focus:border-[#BD1550] focus:ring-1 focus:ring-[#BD1550] focus:outline-none"
                                        required
                                    />
                                </div>
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-md border border-transparent bg-[#BD1550] px-6 py-3 text-center font-medium text-white transition hover:bg-[#a01245] disabled:cursor-not-allowed disabled:opacity-70"
                            >
