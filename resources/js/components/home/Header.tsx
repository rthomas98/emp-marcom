...
export const Header = (props: HeaderProps) => {
    ...
    const containerHeightTransform = useTransform(scrollYProgress, [0, 1], isMobile ? ['60vh', '100vh'] : ['70vh', '100vh']);

    const leftImageGroupXTransform = useTransform(scrollYProgress, [0, 1], isMobile ? ['0vw', '-25vw'] : ['0vw', '-50vw']);

    const centerImageXTransform = useTransform(scrollYProgress, [0, 1], isMobile ? ['0vw', '-25vw'] : ['0vw', '-50vw']);

    const centerImageWidthTransform = useTransform(scrollYProgress, [0, 1], isMobile ? ['50vw', '100vw'] : ['30vw', '100vw']);

    const centerImageHeightTransform = useTransform(scrollYProgress, [0, 1], isMobile ? ['50vh', '100vh'] : ['70vh', '100vh']);

    const rightImageXTransform = useTransform(scrollYProgress, [0, 1], isMobile ? ['0vw', '25vw'] : ['0vw', '20vw']);
    ...
    return (
        <section id="hero" className="relative h-[250vh]" aria-labelledby="hero-heading">
            ...
            <a href="#main-content" className="focus:text-primary sr-only focus:not-sr-only focus:absolute focus:z-50 focus:bg-white focus:p-4">
                Skip to main content
            </a>
            <div className="px-[5%] pt-16 md:pt-24 lg:pt-28">
                <div className="container mx-auto">
                    <div className="w-full max-w-3xl">
                        <h1 id="hero-heading" className="font-header text-primary mb-5 text-4xl font-bold md:mb-6 md:text-5xl lg:text-6xl">
                            {title}
                        </h1>
                ...
                >
                    ...
                    >
                        <div className="relative top-[5%] hidden w-[40vw] sm:w-[25vw] md:block lg:w-[22vw]">
                            <img
                                className="aspect-[2/3] w-full rounded-lg border border-gray-200 object-cover"
                                src={images[0].src}
                                alt={images[0].alt}
                                loading="lazy"
                                width="400"
                    ...
                    <motion.div className="relative" style={centerImageContainer} aria-hidden="true">
                        <img
                            className="size-full rounded-lg border border-gray-200 object-cover"
                            src={images[4].src}
                            alt={images[4].alt}
                            loading="lazy"
                            width="600"
                    ...
                    <motion.div className="grid grid-flow-col grid-cols-1 gap-4 justify-self-start px-4" style={rightImage} aria-hidden="true">
