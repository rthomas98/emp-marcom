                    ...
                    <div className="overflow-hidden">
                        <div className="flex" role="region" aria-live="polite">
                            {getVisibleTestimonials().map(({ testimonial, index }) => (
                                <article
                                    key={index}
                                    className={clsx('w-full shrink-0 px-3', {
                                ...
                                >
                                    <div className="flex h-full w-full flex-col items-start justify-between rounded-lg border border-gray-200 p-6 md:p-8">
                                        ...
                                        <footer className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                                            ...
                                            <div>
                                                <p id={`testimonial-author-${index}`} className="text-primary font-semibold">
                                                    {testimonial.name}
                                                </p>
                    ...
                    <div className="mt-8 flex items-center justify-between">
                        ...
                        <div className="flex items-end justify-end gap-2 md:gap-4" role="navigation" aria-label="Testimonial carousel controls">
                            <button
                                type="button"
                                onClick={prev}
                                className="text-primary focus:ring-primary flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white hover:bg-gray-50 focus:ring-2 focus:ring-offset-2 focus:outline-none"
