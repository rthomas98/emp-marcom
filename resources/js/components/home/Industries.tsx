      ...
      <div className="container mx-auto">
        ...
        <div className="grid auto-cols-fr grid-cols-1 items-start gap-12 md:grid-cols-3 md:gap-8 lg:gap-12">
          <article className="w-full" aria-labelledby="industry-healthcare-heading">
            ...
            <h3 id="industry-healthcare-heading" className="mb-3 text-2xl font-bold text-white md:mb-4 md:text-3xl md:leading-[1.3] lg:text-4xl">
              Healthcare
            </h3>
          ...
          <article className="w-full md:mt-[25%]" aria-labelledby="industry-finance-heading">
            ...
            <h3 id="industry-finance-heading" className="mb-3 text-2xl font-bold text-white md:mb-4 md:text-3xl md:leading-[1.3] lg:text-4xl">
              Finance & Banking
            </h3>
            <p className="text-white/80">
          ...
          <article className="w-full md:mt-[50%]" aria-labelledby="industry-retail-heading">
            ...
            <h3 id="industry-retail-heading" className="mb-3 text-2xl font-bold text-white md:mb-4 md:text-3xl md:leading-[1.3] lg:text-4xl">
              Retail & E-commerce
            </h3>
            <p className="text-white/80">
        ...
        <div className="mt-6 flex flex-wrap gap-4 md:mt-8" role="navigation" aria-label="Industry information links">
          <Link
            ...
            aria-label="Learn more about our industry expertise"
          >
            Learn More
          </Link>
          <Link
