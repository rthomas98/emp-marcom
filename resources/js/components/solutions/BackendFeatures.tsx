      ...
      <div className="container mx-auto">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="max-w-3xl">
            <h2 id="backend-features-heading" className="text-4xl leading-[1.2] font-bold font-header text-primary md:text-5xl lg:text-6xl">
          ...
          <article className="flex flex-col">
            <figure className="mb-6 md:mb-8">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Team of API integration specialists working on server-side logic</figcaption>
            </figure>
            <h3 id="api-integrations-heading" className="mb-3 text-xl font-bold font-header text-primary md:mb-4 md:text-2xl">
          ...
          <article className="flex flex-col">
            <figure className="mb-6 md:mb-8">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Developers creating custom backend solutions for business needs</figcaption>
            </figure>
            <h3 id="custom-solutions-heading" className="mb-3 text-xl font-bold font-header text-primary md:mb-4 md:text-2xl">
          ...
          <article className="flex flex-col">
            <figure className="mb-6 md:mb-8">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Database experts optimizing database performance and security</figcaption>
            </figure>
            <h3 id="database-management-heading" className="mb-3 text-xl font-bold font-header text-primary md:mb-4 md:text-2xl">
