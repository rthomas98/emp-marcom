    ...
    <section id="backend-solutions" className="px-[5%] py-16 md:py-24 lg:py-28" aria-labelledby="backend-solutions-heading">
      <div className="container mx-auto">
        <div className="mx-auto mb-12 w-full max-w-3xl text-center md:mb-18 lg:mb-20">
          ...
          <h2 id="backend-solutions-heading" className="mb-5 text-4xl font-bold font-header text-primary md:mb-6 md:text-5xl lg:text-6xl">
          ...
          <article className="flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
            <div className="block flex-1 p-6 sm:flex sm:flex-col sm:justify-center md:p-8">
              <div>
                ...
                <h3 id="efficiency-heading" className="mb-3 text-2xl font-bold font-header text-primary md:mb-4 md:text-3xl md:leading-[1.3] lg:text-4xl">
              ...
              <div className="mt-5 md:mt-6">
                <Link
                  ...
                  aria-label="Learn more about our tailored server-side operations"
                >
                  Learn More
            ...
            <figure className="flex size-full flex-col items-center justify-center self-start">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Team of developers working on server-side solutions</figcaption>
            </figure>
          </article>
          <article className="grid auto-cols-fr grid-cols-1 flex-col overflow-hidden rounded-lg border border-gray-200 bg-white sm:grid-cols-2 lg:col-span-2">
            <div className="block p-6 sm:flex sm:flex-col sm:justify-center md:p-8">
              <div>
                ...
                <h3 id="integration-heading" className="mb-3 text-2xl font-bold font-header text-primary md:mb-4 md:text-3xl md:leading-[1.3] lg:text-4xl">
              ...
              <div className="mt-5 md:mt-6">
                <Link
                  href="/contact"
                  className="inline-flex items-center text-[#BD1550] hover:underline"
                  aria-label="Contact us about API integration services"
                >
                  Contact Us
                  <ChevronRight className="ml-1 h-4 w-4" aria-hidden="true" />
                </Link>
            ...
            <figure className="flex size-full flex-col items-center justify-center self-start">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Team of specialists working on API integration solutions</figcaption>
            </figure>
          </article>
        </div>
      </div>
