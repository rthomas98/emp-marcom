      ...
      <div className="container mx-auto">
        <div className="mb-12 grid grid-cols-1 items-start gap-5 md:mb-18 md:grid-cols-2 md:gap-x-12 lg:mb-20 lg:gap-x-20">
          <div>
            ...
            <h2 id="custom-software-heading" className="text-4xl font-bold font-header text-primary md:text-5xl lg:text-6xl">
          ...
          <article aria-labelledby="custom-dev-heading">
            <figure className="mb-6 md:mb-8">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Team of developers discussing software architecture</figcaption>
            </figure>
            <h3 id="custom-dev-heading" className="mb-5 text-2xl font-bold text-primary md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
          ...
          <article aria-labelledby="quality-efficiency-heading">
            <figure className="mb-6 md:mb-8">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Designers and developers collaborating on quality software</figcaption>
            </figure>
            <h3 id="quality-efficiency-heading" className="mb-5 text-2xl font-bold text-primary md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
          ...
          <article aria-labelledby="scalable-solutions-heading">
            <figure className="mb-6 md:mb-8">
              <img
                ...
                loading="lazy"
              />
              <figcaption className="sr-only">Team planning scalable software architecture</figcaption>
            </figure>
            <h3 id="scalable-solutions-heading" className="mb-5 text-2xl font-bold text-primary md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
        ...
        <div className="mt-12 flex items-center gap-4 md:mt-18 lg:mt-20" role="navigation" aria-label="Custom software solutions actions">
          <Link
            href="/solutions"
            ...
            aria-label="Learn more about our custom software solutions"
          >
            Learn More
          </Link>
          <Link
            ...
            aria-label="Contact us about your custom software needs"
          >
            Contact Us
