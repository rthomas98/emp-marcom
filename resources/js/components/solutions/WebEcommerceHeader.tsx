        ...
        >
            <div className="mx-[5%] max-w-[40rem] justify-self-start lg:mr-20 lg:ml-[5vw] lg:justify-self-end">
                <h1 id="web-ecommerce-heading" className="font-header text-primary mb-5 text-5xl font-bold md:mb-6 md:text-6xl lg:text-7xl">
                    Modernize a Website That No Longer Serves the Business
                </h1>
                <p className="text-gray-700 md:text-lg">
                    We help Dallas businesses improve slow, difficult-to-manage websites and e-commerce platforms. The work is scoped around customer
                    journeys, performance, accessibility, content operations, and maintainability.
                </p>
            ...
            <div
                className="h-[30rem] overflow-hidden pr-[5vw] pl-[5vw] md:h-[40rem] lg:h-screen lg:pl-0"
                aria-label="Web and e-commerce development showcase"
                role="region"
            >
                <div className="grid w-full grid-cols-2 gap-x-4">
                    <div className="animate-loop-vertically -mt-[120%] grid size-full columns-2 grid-cols-1 gap-4 self-center">
                    ...
                    <div className="animate-loop-vertically-reverse grid size-full grid-cols-1 gap-4">
                        <div className="grid size-full grid-cols-1 gap-4">
                            <div className="relative w-full pt-[120%]">
                                <img
                                    className="rounded-image absolute inset-0 size-full object-cover"
