  ...
  return (
    <section id="frontend-header" className="relative px-[5%] py-16 md:py-24 lg:py-28" aria-labelledby="frontend-header-heading">
      <div className="relative z-10 container mx-auto max-w-3xl text-center">
        ...
        <h1 id="frontend-header-heading" className="mb-5 text-4xl font-bold font-header text-white md:mb-6 md:text-5xl lg:text-6xl">
        ...
        <nav className="mt-6 flex flex-wrap items-center justify-center gap-4 md:mt-8" aria-label="Frontend header navigation">
          <Link
            href="/solutions"
            ...
            aria-label="Learn more about our frontend development solutions"
          >
            Learn More
          </Link>
          <Link
      ...
      <div className="absolute inset-0 z-0" role="img" aria-label="Background image of frontend development team working together">
        <img
