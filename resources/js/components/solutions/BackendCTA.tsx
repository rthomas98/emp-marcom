...
export function BackendCTA() {
  return (
    <section id="backend-cta" className="relative px-[5%] py-16 md:py-24 lg:py-28">
        ...
        <div className="grid w-full grid-cols-1 items-start justify-between gap-6 md:grid-cols-[1fr_max-content] md:gap-x-12 md:gap-y-8 lg:gap-x-20">
          <div className="md:mr-12 lg:mr-0">
            <div className="w-full max-w-lg">
              <h2 className="mb-3 text-4xl leading-[1.2] font-bold font-header text-white md:mb-4 md:text-5xl lg:text-6xl">
