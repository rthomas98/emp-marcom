                ...
                <div className="px-[5%]">
                  <div className="container mx-auto">
                    <div className="flex h-16 w-full items-center">
                      ...
                      <h3 id={stepId} className="font-semibold font-header text-primary md:text-lg">
                        {step.title}
                      </h3>
                    </div>
                    <div className="py-8 md:py-10 lg:py-12">
                      <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                        <div>
                          ...
                          <h2 id={`${stepId}-heading`} className="mb-5 text-4xl font-bold font-header text-primary md:mb-6 md:text-5xl lg:text-6xl">
                            {step.heading}
                          </h2>
                          <p className="text-gray-700 md:text-lg">
                            {step.description}
                          </p>
                          <nav className="mt-6 flex flex-wrap items-center gap-4 md:mt-8" aria-label={`${step.title} navigation`}>
                            <Link
                              href="/solutions"
                            ...
                            <Link
                              ...
                              aria-label={`Start your project with ${step.title.toLowerCase()}`}
                            >
                              Start A Project
                        ...
                        <figure className="relative">
                          <img
                            ...
                            loading="lazy"
                          />
                          <figcaption className="sr-only">{step.title} - Visual representation of our {step.title.toLowerCase()} process</figcaption>
                        </figure>
                      </div>
                    </div>
                  </div>
