            ...
            <div className="container mx-auto">
                <div className="mb-12 md:mb-16 lg:mb-20">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <h2 className="mb-5 text-4xl font-bold text-[#1F1946] md:mb-6 md:text-5xl">Connect With Our Boutique Team</h2>
                        <p className="md:text-md text-gray-700">
                            Unlike larger firms where your inquiry might be handled by junior staff, our specialized micro agency founded in 2009 by
                            Robert Thomas provides direct access to senior specialists. Reach out through any channel below for personalized attention
                ...
                <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
                    ...
                    <div className="flex flex-col items-center rounded-lg border border-gray-200 bg-white p-8 text-center transition">
                        ...
                        <p className="mb-6 text-gray-700">
                            Chat directly with our senior specialists in real-time—experiencing the personalized attention that only a micro agency
                            can provide.
                        </p>
                        <Link
                            href="/contact"
