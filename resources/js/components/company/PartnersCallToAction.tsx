        ...
        <section id="partners-cta" className="relative px-[5%] py-16 md:py-24 lg:py-28">
            <div className="relative z-10 container mx-auto">
                <div className="grid grid-rows-1 items-start gap-y-5 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:gap-x-20 lg:gap-y-16">
                    <div>
                        <h2 className="text-4xl font-bold text-white md:text-5xl lg:text-6xl">Experience the Micro Agency Advantage</h2>
                    </div>
                    <div>
                        <p className="md:text-md text-white">
                            Partner with our boutique agency founded in 2009 by Robert Thomas for direct access to senior specialists who deliver
                            personalized technology solutions with faster implementation times than larger firms can offer—all without the overhead of
