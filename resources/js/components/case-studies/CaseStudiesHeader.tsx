        ...
        <section className="relative h-[300vh]">
            <div className="sticky top-0 h-screen overflow-hidden">
                    ...
                    <div className="px-[5%] py-16 md:py-24 lg:py-28">
                        <div className="relative z-10 mx-auto max-w-3xl text-center">
                            <h1 className="mb-5 text-4xl font-bold text-white md:mb-6 md:text-6xl lg:text-7xl">
                                Selected Client Work and Delivery Stories
                            </h1>
                            <p className="md:text-md text-white">
                                Review the business context, technical challenge, solution, and available outcomes behind selected Empuls3
                                engagements. We are expanding this library as verified client metrics are approved for publication.
                            </p>
                ...
                <div className="absolute inset-0 z-0">
                    <motion.div className="absolute inset-0 z-10 bg-[#1F1946]/70" style={{ opacity: opacityOverlay }} />
                    <motion.div style={{ scale }} className="grid size-full auto-cols-fr grid-cols-1 gap-x-4 gap-y-4 md:grid-cols-3">
