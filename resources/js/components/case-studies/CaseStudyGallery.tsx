...
export function CaseStudyGallery({ relatedCaseStudies = [] }: CaseStudyGalleryProps) {
  // Sample case studies for preview if none provided
  ...
  const displayCaseStudies = relatedCaseStudies.length > 0 ? relatedCaseStudies : sampleCaseStudies;
              ...
              <div className="relative overflow-hidden rounded-lg">
                <img
                  src={caseStudy.featured_image.startsWith('/storage/') 
                    ...
                    : (caseStudy.featured_image.startsWith('/') 
                      ? caseStudy.featured_image 
                      : `/storage/${caseStudy.featured_image}`)}
                  alt={caseStudy.title}
