      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-start">
          ...
          <div className="grid grid-cols-1 items-start gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            ...
            <article className="flex flex-col" aria-labelledby="proactive-support-heading">
              <div className="mb-5 md:mb-6">
                <Shield className="h-12 w-12 text-[#BD1550]" aria-hidden="true" />
              </div>
              <h3 id="proactive-support-heading" className="mb-5 text-2xl font-bold text-[#1F1946] md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
            ...
            <article className="flex flex-col" aria-labelledby="project-support-heading">
              <div className="mb-5 md:mb-6">
                <UserPlus className="h-12 w-12 text-[#BD1550]" aria-hidden="true" />
              </div>
              <h3 id="project-support-heading" className="mb-5 text-2xl font-bold text-[#1F1946] md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
          ...
          <nav className="mt-10 flex items-center gap-4 md:mt-14 lg:mt-16" aria-label="IT support navigation">
            <Link
              href="/contact"
              ...
              aria-label="Learn more about our IT support services"
            >
              Learn More
            </Link>
          </nav>
