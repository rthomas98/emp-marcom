      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <article className="flex w-full flex-col items-center text-center" aria-labelledby="senior-strategists-heading">
              <div className="mb-5 md:mb-6">
                <FileSearch className="h-12 w-12 text-[#BD1550]" aria-hidden="true" />
              </div>
              <h3 id="senior-strategists-heading" className="mb-5 text-2xl font-bold text-[#1F1946] md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
            ...
            <article className="flex w-full flex-col items-center text-center" aria-labelledby="agile-approach-heading">
              <div className="mb-5 md:mb-6">
                <GitBranch className="h-12 w-12 text-[#BD1550]" aria-hidden="true" />
              </div>
              <h3 id="agile-approach-heading" className="mb-5 text-2xl font-bold text-[#1F1946] md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
            ...
            <article className="flex w-full flex-col items-center text-center" aria-labelledby="personalized-support-heading">
              <div className="mb-5 md:mb-6">
                <Rocket className="h-12 w-12 text-[#BD1550]" aria-hidden="true" />
              </div>
              <h3 id="personalized-support-heading" className="mb-5 text-2xl font-bold text-[#1F1946] md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl">
          ...
          <nav className="mt-10 flex items-center gap-4 md:mt-14 lg:mt-16" aria-label="DevOps process navigation">
            <Link
              ...
              aria-label="Learn more about our DevOps process"
            >
              Learn More
            </Link>
            <Link
              ...
              aria-label="Contact us about our DevOps process"
            >
              Contact Us
