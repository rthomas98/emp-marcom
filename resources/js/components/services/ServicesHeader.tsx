                ...
                <div className="ml-[5%]">
                    <header className="mb-12 w-full max-w-5xl md:mb-18 lg:mb-20">
                        ...
                        <p className="md:text-md text-gray-700">
                            We help Dallas-Fort Worth businesses rescue aging software, connect disconnected systems, and support critical technology
                            with senior specialists who work directly with your team.
                        </p>
                        <nav className="mt-6 flex gap-x-4 md:mt-8" aria-label="Services navigation">
                            <Link
                                href="/contact"
                                className="inline-flex h-11 min-h-[44px] items-center justify-center rounded-md bg-[#BD1550] px-6 py-2.5 text-base font-medium text-white shadow-sm hover:bg-[#BD1550]/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#BD1550] focus-visible:ring-offset-2"
                            ...
                            <Link
                                href="/case-studies"
                                className="inline-flex h-11 min-h-[44px] items-center justify-center rounded-md border-2 border-[#1F1946] bg-transparent px-6 py-2.5 text-base font-medium text-[#1F1946] shadow-sm hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#BD1550] focus-visible:ring-offset-2"
                ...
                <div className="grid auto-cols-fr grid-cols-1 items-end gap-6 sm:grid-cols-[1fr_0.4fr_0.4fr] sm:gap-8" aria-label="Team imagery">
                    ...
                    <figure className="w-full self-start">
                        ...
                        <figcaption className="sr-only">
                            Two business professionals shaking hands, symbolizing partnership and collaboration
                        </figcaption>
                    </figure>
                </div>
            </div>
