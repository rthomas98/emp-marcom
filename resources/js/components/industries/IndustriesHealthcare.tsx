    ...
    <section id="industries-healthcare" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container mx-auto">
        <div className="mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
          <div>
            <p className="mb-3 font-semibold text-[#BD1550] md:mb-4">Healthcare</p>
            <h3 className="text-4xl font-bold leading-[1.2] text-[#1F1946] md:text-5xl lg:text-6xl">
              Innovative Solutions for the Healthcare Sector
            </h3>
          </div>
          <div>
            <p className="mb-6 text-gray-700 md:mb-8 md:text-md">
              Empuls3 offers tailored technology solutions that enhance patient
              care and streamline healthcare operations. Our expertise ensures
              compliance with industry regulations while driving efficiency.
            </p>
            <div className="grid grid-cols-1 gap-6 py-2 sm:grid-cols-2">
              <div>
                ...
                <p className="text-gray-700">
                  Enhance patient experiences with our custom healthcare
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Streamline operations with our innovative software and support
                  services.
                </p>
              </div>
            </div>
