    ...
    <section id="industries-education" className="bg-[#F8F9FA] px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container mx-auto">
        <div className="mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
          <div>
            <p className="mb-3 font-semibold text-[#BD1550] md:mb-4">Boutique Education Solutions</p>
            <h3 className="text-4xl font-bold leading-[1.2] text-[#1F1946] md:text-5xl lg:text-6xl">
              Personalized Education Technology with Senior Expertise
            </h3>
          </div>
          <div>
            <p className="text-gray-700 md:text-md">
              As a specialized micro agency, Empuls3 offers truly personalized digital solutions designed to enhance learning experiences and streamline the management of educational institutions. Unlike larger firms where your project might be handed off to junior staff, our boutique team of senior specialists works directly with you—empowering educators and administrators to leverage data-driven insights for improved outcomes. From custom software to e-learning platforms, we provide personalized solutions with faster implementation times and more dedicated attention than larger firms can provide.
            </p>
