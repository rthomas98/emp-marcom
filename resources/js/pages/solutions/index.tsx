    ...
    return (
        <SiteLayout title={generateLocalTitle('Software Development Solutions', true)}>
            <Head>
                <meta
                    ...
                    content={generateLocalDescription(
                        'Professional Dallas software development solutions including custom web applications, mobile apps, API development, and UX/UI design. Serving DFW businesses with personalized technology solutions.',
                    )}
                />
                <meta
                    name="keywords"
                    content="Dallas software development, Dallas web development, Dallas mobile app development, Dallas API development, Dallas UX UI design, custom software Dallas, Dallas tech solutions, DFW software company"
                />
                {/* Open Graph Tags for better social sharing */}
                <meta property="og:title" content={generateLocalTitle('Software Development Solutions', true)} />
                <meta
                    property="og:description"
                    content="Professional Dallas software development solutions with direct senior developer attention. Custom web apps, mobile apps, and technology solutions for DFW businesses."
                />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.empuls3.com/solutions" />
                ...
                <script type="application/ld+json">{`
          {
            ...
            "url": "https://www.empuls3.com/solutions",
            "speakable": {
              ...
              "itemListElement": [
                {
                  ...
                  "position": 1,
                  "name": "Home",
                  "item": "https://www.empuls3.com"
                },
                {
                  "@type": "ListItem",
                  "position": 2,
                  "name": "Solutions",
                  "item": "https://www.empuls3.com/solutions"
                }
              ]
            },
            "mainEntity": {
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "url": "https://www.empuls3.com/solutions/mobile-development"
                },
                {
                  "@type": "Service",
                  "position": 3,
                ...
                },
                {
                  ...
                  "url": "https://www.empuls3.com/solutions/frontend-development-ux-ui-design"
                }
              ]
            }
          }
        `}</script>
            ...
            <a
                ...
                className="focus:bg-primary sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:rounded-md focus:px-4 focus:py-2 focus:text-white focus:outline-none"
            >
