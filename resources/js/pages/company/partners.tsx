...
export default function Partners() {
    ...
    const partnershipInfo = {
        ...
        description:
            "Empuls3's strategic partnerships as a specialized micro agency, collaborating with industry-leading partners to deliver personalized technology solutions.",
        url: 'https://www.empuls3.com/company/partners',
        partners: [
            {
    ...
    return (
        <SiteLayout>
            <Head>
                ...
                <meta
                    name="description"
                    content="Learn about Empuls3's strategic partnerships as a specialized micro agency. Direct collaboration with senior specialists and industry-leading partners to deliver personalized technology solutions."
                />
                <meta
                    name="keywords"
                    content="micro agency partnerships, boutique technology firm, strategic partners, senior specialists, personalized technology solutions, direct collaboration"
                />
                ...
                <meta
                    ...
                    content="Learn about Empuls3's strategic partnerships as a specialized micro agency, collaborating with industry-leading partners."
                />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.empuls3.com/company/partners" />
                <meta property="og:image" content="https://www.empuls3.com/images/partners-cover.jpg" />
                ...
                <meta name="twitter:image" content="https://www.empuls3.com/images/partners-cover.jpg" />

                {/* JSON-LD structured data */}
                <script type="application/ld+json">{JSON.stringify(partnershipsSchema)}</script>
            </Head>
