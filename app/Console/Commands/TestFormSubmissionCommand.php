...
class TestFormSubmissionCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Test the contact form submission with real form data';
    ...
    {
        $this->info("Testing contact form submission with real data...");
        
        // Sample form data from the user's submission
        $formData = [
            'name' => 'Nell Mckinney',
            'email' => 'qybe@mailinator.com',
            'phone' => '+1 (527) 636-7834',
            'company' => 'Mason and Hahn LLC',
            'message' => 'Similique fugit dol',
            'formType' => 'general',
