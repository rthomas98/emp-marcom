...
class EditCaseStudy extends EditRecord
{
    ...
    public function mount($record): void
    {
        ...
        $mediaDisk = Storage::disk(config('filesystems.media', 'public'));

        $mediaDisk->makeDirectory('case-studies/featured');
        $mediaDisk->makeDirectory('case-studies/logos');
        $mediaDisk->makeDirectory('case-studies/gallery');
    }
